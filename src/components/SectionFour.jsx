...
const SectionFour = () => {
  return (
    <section id="s2" className="bg-gradient-to-tr from-remitech-purple to-remitech-turquoise to-85% min-h-120 lg:pt-12 overflow-y-hidden lg:pb-24">
        ...
        <div className="order-2 lg:order-3 lg:relative lg:left-125 lg:bottom-279">
          <ClientOnlyWrapper>
            <SlideElementWrapper slideFrom="bottomRight">
              <div className="bg-white px-5 py-6 pb-3 text-sm text-black font-medium rounded-lg lg:max-w-[372px] mb-5">
                ...
                <h5 className="text-2xl pb-2 font-normal">Register Interest:</h5>
                <ContactForm />
              </div>
            </SlideElementWrapper>
          </ClientOnlyWrapper>
