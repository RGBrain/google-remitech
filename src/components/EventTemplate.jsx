...
const EventTemplate = ({ eventData, textPos, lastEvent = false }) => {
  ...
  return (
    <article
      ref={thisEvent}
      className={`flex flex-col ${textPos === "left" ? `lg:mr-28` : `lg:ml-10`} my-18 lg:my-28 items-start space-y-5 lg:space-y-10 lg:h-[765px] lg:mb-38 ${lastEvent === true ? `overflow-hidden pt-20 lg:pt-18 -mt-20 lg:-mt-22` : ``}`}
    >
      <div className={`lg:relative lg:bottom-162 lg:order-2 self-stretch z-30 mt-24 lg:mt-0 lg:self-start ${textPos === "left" ? `lg:left-10` : `lg:left-106`}`}>
        <ClientOnlyWrapper>
      ...
      <div className={`lg:relative lg:bottom-258 lg:order-3 z-40 -mt-3 lg:-mt-0 ${textPos === "left" ? `lg:left-22` : `lg:left-119`}`}>
        <ClientOnlyWrapper>
