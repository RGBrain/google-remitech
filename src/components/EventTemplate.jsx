...
const EventTemplate = ({ eventData, textPos, lastEvent = false }) => {
  ...
  return (
    <article className={`flex flex-col ${textPos === "left" ? `lg:mr-20` : `lg:ml-10`} my-18 lg:my-28 items-start space-y-5 lg:h-[765px] ${lastEvent === true ? `overflow-hidden pt-20 lg:pt-10 -mt-20` : ``}`}>
