...
eventData.eventText.push(
  `Join Us for an evening of great food, drinks, conversation, and an informal Q&A with Arek Dreyer, renowned Apple expert and trainer, on Thursday, 26th June from 6:00pm at a Kings Cross rooftop.`
);
eventData.eventText.push(
  `Arek will be sharing his thoughts on what’s new and noteworthy for MacAdmins following WWDC25 — plus answering your questions live on the night.`
);
eventData.eventText.push(
