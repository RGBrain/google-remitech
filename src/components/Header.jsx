...
const Header = () => {
  return (
    <header id="hhh" className="bg-gradient-to-tr from-remitech-purple to-remitech-turquoise w-full sticky top-0 z-40">
      ...
      <div className="flex justify-center md:justify-between items-center min-h-[84px] lg:min-h-[125px] max-w-[1450px] mx-auto">
        ...
        <RemitechLogo className="fill-foreground w-80 md:mr-18" />
