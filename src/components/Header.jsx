...
const Header = () => {
  return (
    <header id="hhh" className="bg-white w-full sticky top-0 z-40 ">
      ...
      <div className="flex justify-center md:justify-between items-center min-h-[84px] md:min-h-[110px] lg:min-h-[125px] max-w-[1450px] mx-auto">
        ...
        <div className="hidden md:block m-5 ml-10 lg:ml-16 -mt-1">
          {/* putting this div with 'hidden' around the Button.*/}

          <BtnPDF />
        </div>
        <Image src="/remitech-logo-color.png" width={300} height={400} alt="Remitech Logo" className="md:mr-18" />
